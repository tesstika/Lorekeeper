...
<template>
  <div class="pointer-events-none fixed inset-x-0 bottom-16 z-50 flex flex-col items-center gap-2 px-4">
    <div
      ...
      :class="{
        ...
        'border-error/50 bg-error-container/90 text-on-error-container': toast.tone === 'error',
      }"
    >
      {{ toast.message }}
    </div>
